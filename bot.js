...
var html = '<div><select id="bottikus_maximus_selectedSeed"><option value="redMushroomSeeds">Mushroom Seeds (red)</option><option value="blewitMushroomSeeds">Mushroom Seeds (blue - blewit)</option><option value="snapegrassSeeds">Snape Grass Seeds</option><option value="greenLeafSeeds">Green Leaf Seeds</option><option value="dottedGreenLeafSeeds">Dotted Green Leaf Seeds</option><option value="limeLeafSeeds">Lime Leaf Seeds</option><option value="goldLeafSeeds">Gold Leaf Seeds</option><option value="crystalLeafSeeds">Crystal Leaf Seeds</option><option value="stripedCrystalLeafSeeds">Striped Crystal Leaf Seeds</option><option value="treeSeeds">Tree Seeds</option><option value="oakTreeSeeds">Oak Tree Seeds</option><option value="willowTreeSeeds">WillowT ree Seeds</option><option value="mapleTreeSeeds">Maple Tree Seeds</option><option value="stardustTreeSeeds">Sardust Tree Seeds</option><option value="essenceTreeSeeds">Essence Tree Seeds</option><option value="grassSeeds">Grass Seeds</option></select><br/><input type="number" id="bottikus_maximus_patchAmmount" value="0" placeholder="Number of Patches you own"></input><br/><button onclick="is_BottkusMaximusFarming = true;">Start Farming</button><button onclick="is_BottkusMaximusFarming = false;">Stop Farming</button></div>';
$("#tab-sub-container-farming").append(html);

var html = '<div><select id="bottikus_maximus_selectedPotion"><option value="stardustPotion">Stardust Potion</option><option value="oilPotion">Oil Potion</option><option value="superStardustPotion">Super Stardust Potion</option></select><br/><button onclick="is_BottkusMaximusDrinkingPotions = true;">Start Using</button><button onclick="is_BottkusMaximusDrinkingPotions = false;">Stop Using</button></div>';
